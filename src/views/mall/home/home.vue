        ...
        <c-header>
            ...
            <c-box-skin type="bottom">
                <c-columns>
                    ...
                    <c-search class="search" @click="isShow = !isShow" text="睡衣" mt15 mb15 mr20 radius4></c-search>
                    <c-svg-more @click="goChat" size="24" :colors="['#c0c0c0', '#fff', '#c0c0c0']"></c-svg-more>
                </c-columns>
            </c-box-skin>
        </c-header>
                    ...
                    >
                        <c-box-skin class="good__item" mb12 radius4>
                            ...
                            <div class="good__box" pv24 ph12>
                                ...
                                <c-avatar class="good__avatar" :url="item['avatarImage']" :text="item['avatarDes']"></c-avatar>
                            </div>
                        </c-box-skin>
                    </router-link>
                </c-col>

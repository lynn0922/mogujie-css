                        ...
                        <c-col span="8" v-for="(item, index) in hotGoodList" :key="index">
                            <c-box-skin radius4>
                                <c-magazine class="good__image" :image="item['image']">
                                    <c-button class="good__number" pv4 ph10 bga5 font-tertiary>{{ item['sell'] }}</c-button>
                                </c-magazine>
                                ...
                                <c-columns pb20>
                                    <div>
                                        ...
                                        <div style="color: #999; text-decoration: line-through" pl4>
                                            {{ item['oldprice'] }}
                                        </div>
                                    </div>
            ...
            <c-magazine image="https://s10.mogucdn.com/mlcdn/c45406/201104_872b0le054e822e6hh4fcjf95fl92_750x117.png">
                <c-columns class="time">
                    <c-button class="time__container" v-for="(item, i) in time" :key="i">
                        <b class="time__t" :class="{ 'time__t--active': item['active'] }">{{ item['t'] }}</b>
                        <c-button
                            class="time__status"
...
<style lang="scss" scoped>
    ...
    @include b(header) {
        background: url('https://s10.mogucdn.com/mlcdn/c45406/201103_154d6c9b491c6d29af5l9a5487h6i_750x225.png') no-repeat top
            center / contain;
        @include e(today) {
            font-family: feichi;
            font-size: 40px;
    ...
    @include b(time) {
        ...
        @include e(status) {
            ...
            @include calc(border-radius, '36px / 2');
            opacity: 0.8;
            @include m(active) {
                opacity: 1;

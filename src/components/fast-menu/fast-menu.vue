<template>
    <div class="c-fast-menu">
        ...
        <div class="c-fast-menu__box">
            <c-columns class="c-fast-menu__container" :class="{ 'c-fast-menu__container--home': show }" mt26 pr10>
            ...
            <c-button class="c-fast-menu__btn" @click="show = !show" mt26 circle bga7> 快捷<br />导航 </c-button>
            <van-popup v-model:show="showPop" position="top">
                <c-row pv30>
                    ...
                    <c-col span="8">
                        <c-button>
                            <div class="c-fast-menu__theme c-fast-menu__theme--warm" @click="changeTheme('warm')" circle></div>
                        </c-button>
                    </c-col>
                    <c-col span="8">
                        <c-button>
                            <div class="c-fast-menu__theme c-fast-menu__theme--cool" @click="changeTheme('cool')" circle></div>
                        </c-button>
                    </c-col>
                </c-row>
            </van-popup>

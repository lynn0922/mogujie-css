            ...
            'data|4': [
                {
                    ...
                    'path|+1': ['/promotion/fast-buy', '/promotion/fast-buy', '/mall/home', '/mall/goods?id=0&des=新品快抢']
                }
            ],
            status: 200,
            msg: '请求成功'
                ...
                'data|10': [
                    {
                        ...
                        'info|+1': ['2020.09.4 01:48 | 26.8万浏览', '2020.09.28 10:47 | 2.4万浏览', '30 天前 | 1.0万浏览']
                    }
                ]
            })
        } else if (params['id'] == 1) {
                ...
                'data|10': [
                    {
                        ...
                        'des|+1': ['如何拥有少女感？谭松韵颜值&表情管理分析', ' iu唱《Dolphin》～已经被哒哒哒洗脑了😂', '...'],
                        'info|+1': ['2020.09.4 01:48 | 26.8万浏览', '2020.09.28 10:47 | 2.4万浏览', '30 天前 | 1.0万浏览']
                    }
                ]
            })
